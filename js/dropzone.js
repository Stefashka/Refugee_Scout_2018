...
(function ( $, window, document, undefined ) {
    ...
    var pluginName = 'dropzone',
        defaults = {
            ...
            background:             '',
            zIndex:                 100,                            //Z index.html of element
    ...
    function addProgressBar(that, i, index){
        ...
        //$(".progress-" + index.html).parent().append('<span title="'+that.options.files[i].name+'">'+that.options.files[i].name.trunc(20)+'</span>').css("width", that.options.progressBarWidth);
